...
{
    public enum JumpCloudLdapAttributes
    {
    ...
    public static class JumpCloudLdapAttributesExtensions
    {
        /// <summary>
        ...
        public static string ToDescriptionString(this JumpCloudLdapAttributes val)
        {
